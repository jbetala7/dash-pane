                        ...
                        <td style="background: linear-gradient(180deg, rgba(255,255,255,0.08) 0%, rgba(255,255,255,0.04) 100%); border: 1px solid rgba(255,255,255,0.1); border-top: none; border-radius: 0 0 24px 24px; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.4);">
                            ...
                            <tr>
                                <td style="padding: 8px 40px 32px 40px;">
                                        ...
                                        <tr>
                                            <td style="padding: 20px 24px;">
                                                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                                    <tr>
                                                        <td width="48" valign="top">
                                                            <div style="width: 40px; height: 40px; background: linear-gradient(135deg, #007AFF 0%, #00D4FF 100%); border-radius: 10px; text-align: center; line-height: 40px; font-size: 18px; box-shadow: 0 4px 12px rgba(0, 122, 255, 0.4);">🔍</div>
                                                        </td>
                                                        <td style="padding-left: 16px;">
                                                            <p style="margin: 0 0 4px 0; font-size: 14px; font-weight: 600; color: #ffffff;">Fuzzy Window Search</p>
                                                            <p style="margin: 0; font-size: 13px; color: rgba(255,255,255,0.7);">Press <span style="font-family: 'SF Mono', Monaco, monospace; background: rgba(255,255,255,0.15); padding: 3px 8px; border-radius: 6px; font-weight: 600; color: #00D4FF;">⌃ Space</span> to search and jump to any open window</p>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                    ...
                                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background: linear-gradient(135deg, rgba(0, 122, 255, 0.2) 0%, rgba(0, 212, 255, 0.1) 100%); border: 1px solid rgba(0, 212, 255, 0.25); border-radius: 14px;">
                                        <tr>
                                            <td style="padding: 20px 24px;">
                                                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                                    <tr>
